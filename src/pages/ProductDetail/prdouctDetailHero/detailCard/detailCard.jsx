...
const ProductDetailCard = () => {
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-4  mt-28">
      {/* Product image carousel and thumbnails */}
      <div className="relative">
        <div id="mainCarousel" className="carousel w-full">
          <div className="carousel-inner">
        ...
        <div id="thumbCarousel" className="carousel w-full mt-4 flex overflow-x-auto">
          {product.images.map((src, index) => (
            <div
              key={index}
              className={`carousel-item ${index === currentSlide ? 'active' : ''} cursor-pointer`}
              onClick={() => handleThumbnailClick(index)}
            >
              <img
      ...
      <div className="mt-12 container">
        ...
        <div className="content">
          ...
          {activeTab === 'specification' && (
            <div className="specification">
              <p dangerouslySetInnerHTML={{ __html: product.specification }} />
            </div>
          )}
          {activeTab === 'review' && (
            <div className="review">
              <p dangerouslySetInnerHTML={{ __html: product.reviews }} />
            </div>
          )}
        </div>
      </div>
